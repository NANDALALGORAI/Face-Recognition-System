...
class Face_Recognition_System:
    def __init__(self,root):
        ...
        b1=Button(bg_img,image=self.photoimg4,cursor="hand2",command=self.student_record)
        b1.place(x=200, y=100, width=220,height=220)

        b1_1=Button(bg_img,text="Student Details",cursor="hand2", font=("times new roman",20,"bold"),bg="red",fg="white",command=self.student_record)
        ...
        def openlink():
            webbrowser.open("https://forms.gle/UTwRxMJfZiDsWctLA")
        

        b4_4=Button(bg_img,text="Help Desk",cursor="hand2", font=("times new roman",20,"bold"),bg="red",fg="white", command=openlink)
        ...
        b5=Button(bg_img,image=self.photoimg8,cursor="hand2",command=self.train_page)
        b5.place(x=200, y=400, width=220,height=220)

        b5_5=Button(bg_img,text="Train Data",cursor="hand2", font=("times new roman",20,"bold"),bg="red",fg="white",command=self.train_page)
        ...
        b8=Button(bg_img,image=self.photoimg11,cursor="hand2",command=self.isExit)
        b8.place(x=1100, y=400, width=220,height=220)   

        b8_8=Button(bg_img,text="Exit",cursor="hand2", font=("times new roman",20,"bold"),bg="red",fg="white",command=self.isExit)
