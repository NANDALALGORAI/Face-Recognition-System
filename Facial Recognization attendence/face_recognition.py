...
class Face_Recognition:
    def __init__(self,root):
        ...
        title_lbl = Label(self.root,text="FACE DETECTION",font=("times new roman",35,"bold"),bg="white",fg="red")
        title_lbl.place(x=0,y=0,width=1400,height=45)
        
        img_top = Image.open(r"C:\Users\ADMIN\OneDrive\Desktop\CLASS\FACE RECOG\Images\face_detection.png")
        ...
        img_top1 = Image.open(r"C:\Users\ADMIN\OneDrive\Desktop\CLASS\FACE RECOG\Images\face_detection2.jpg")
        ...
        b1_1=Button(self.root,text="DETECT FACE",command=self.face_recog,cursor="hand2",font=("times new roman",30,"bold"),bg="red",fg="white")
        b1_1.place(x=425,y=600,width=500,height=40)
